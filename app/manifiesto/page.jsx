export default function ManifiestoPage() {
  return (
    <main className="px-6 py-16 max-w-4xl mx-auto">
      ...
      <p>
        {/* Tu contenido aquí */}
        <h2>TODOS SOMOS ESCUCHADORES.</h2>
        ...
        <p>Ser un escuchador, significa tener compasión por los otros seres vivos y permitirnos conectar más allá de los paisajes visuales y empezar encontrar belleza en el paisaje sonoro.</p>
       ...
       <div><img src="/nahun_escuchando.png" alt="foto película" className="rounded-lg w-full h-auto" />
        </div>
    </main>
  );
}