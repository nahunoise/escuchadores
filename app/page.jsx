...
>
  ...
  Los paisajes sonoros donde podría existir un escuchador
    ...
    <div>
      ...
      <img src="/logo_ministerio.png" alt="Ministeriodelambiente" className="inline w-30 h-6 mr-2"/>
      <img src="/logo_kai.jpg" alt="Kai" className="inline w-20 h-16 mr-2 mb-1"/>
      <img src="/goctac_lab.png" alt="Goctac" className="inline w-14 h-14 mr-2 mb-1"/>
